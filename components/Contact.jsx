...
const Contact = () => {
  ...
  return (
    <>
    <div className="flex flex-col justify-center items-center bg-neutral-950 z-20">
      ...
      <div className="rounded-xl backdrop-blur-lg p-5 bg-neutral-600/20 mt-12 max-w-6xl w-full select-none">

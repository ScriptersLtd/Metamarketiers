...
const Footer = ({ line1, heading, button }) => {
  return (
    <div className="sticky bottom-0 h-[45rem] w-screen bg-gradient-radial to-purple-950 from-indigo-950 -z-10 flex flex-col justify-end pb-5 items-center">
      ...
      <div className="flex flex-col md:flex-row w-full justify-between items-center px-20">
        ...
        <div className="max-w-4xl flex flex-col gap-y-2 justify-between items-end text-white mt-10 px-4">
          ...
          <div className="flex gap-4">
            <PhoneIcon />
            <Link href="tel:+12067467149" target="_blank" rel="noopener noreferrer">+1 (206) 746-7149</Link>
          </div>

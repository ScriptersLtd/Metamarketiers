...
const DevelopmentText = () => {
  ...
  return (
    <div
      className="py-[250px] xl:py-[600px] w-screen px-3 sm:px-5 bg-neutral-950"
      ref={ref}
    >
      <motion.p className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-neutral-500 text-center max-w-6xl mx-auto">
        ...
        <motion.span
          style={{
            opacity: isSmallScreen ? smallOpacity2 : opacity2,
            color: "white",
          }}
        >
          DEVELOP
        ...
        <motion.span
          style={{
            opacity: smallOpacity1 ? smallOpacity3 : opacity3,
            color: "white",
          }}
        >
          LAUNCH

    ...
    <motion.div className="flex flex-col w-screen overflow-clip relative bg-neutral-950">
      <div className="relative h-fit z-20 bg-neutral-950">
        ...
        <div className="flex flex-col xl:flex-row gap-x-4 justify-center items-center w-screen pb-36 gap-y-4">
          <PerformanceCard name={"Laser Focused Precision"} desc={"Get razor-sharp insights and a crystal-clear focus on your brand’s first yet lasting impression. Just like a magnifying glass, we focus on the specifics; enhancing your site’s visibility, refining every click, and optimizing each interaction. It’s about catching every opportunity for a big impact with our expert web development solutions, so every visitor sees you at your best—no details missed!"} turnedheading={"See Beyond the Ordinary!"} turneddesc={"Get razor-sharp insights and a crystal-clear focus on your brand’s first yet lasting impression. Just like a magnifying glass, we focus on the specifics; enhancing your site’s visibility, refining every click, and optimizing each interaction. It’s about catching every opportunity for a big impact with our expert web development solutions, so every visitor sees you at your best—no details missed!"} image={"/development/benefit-image-1.png"} cta={"Zoom in!"} />

          <PerformanceCard name={"Bright Ideas, Brighter Sites"} desc={"Good ideas deserve great platforms. We light the way with user-centric designs that capture creativity and innovation, blending bright ideas into stunning web experiences. From unique visuals to intuitive layouts, we bring your concepts to life with a spark that sets you apart. Because it's not just a website; it's a journey your audience will want to take again and again!"} turnedheading={"Switch On the Innovation!"} turneddesc={"Let your brand’s brilliance shine with clever, intuitive designs that go beyond aesthetics. Every page and every click is a golden chance to tell your story in a way that’s compelling, clear, and creatively crafted—reflecting your business vibe and values. Trust our dependable web development company to fuse form with function, turning every interaction into an inspired connection. Ready for your site to feel like home to your users?"} image={"/development/benefit-image-2.png"} cta={"Stand Out!"} />

          <PerformanceCard name={"High Voltage Performance"} desc={"Unmatched speed is no longer a luxury—it's a necessity! As a leading web development company in USA, our lightning-fast websites ensure zero lag, keeping your audience engaged and happy. We prioritize speed, optimizing every element to create a smooth, fast, and unforgettable experience that electrifies your visitors, making them come back for more."} turnedheading={"Power Up Your Digital Presence!"} turneddesc={"Speed isn't just about numbers; it's about customer satisfaction. Your users deserve a speed-driven experience that doesn't miss a beat. Let us accelerate your web presence with performance that feels effortless, crisp and full of spark—because a slow site is yesterday’s news!"} image={"/development/benefit-image-3.png"} cta={"Charge Up!"} />
        </div>
      </div>
      <Footer line1={"Combining Beauty and Brains in Web Development to Make Your Online Presence Unforgettable and Profitable!"} heading={"Your Vision, Our Code—Websites That Mean Business"} button={"Uncover The Magic!"} />
    </motion.div>
  );
};

const PerformanceCard = ({name,desc,turnedheading,turneddesc,image,cta}) => {
  ...
  return (
    ...
    >
      <motion.div
        ...
        transition={{ duration: 0.6, ease: "easeInOut" }}
      >
      <p className="text-neutral-100 text-3xl font-bold scale-x-[-1]">{turnedheading}</p>
      ...
      >
        ...
        <p className="  text-neutral-100 text-sm pt-4 px-4">
         {desc}
        </p>

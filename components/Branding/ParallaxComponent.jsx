...
const ParallaxComponent = () => {
  ...
  const col3 = useTransform(scrollYProgress, [0, 0.2,0.4, 0.5], ["","", "", "#fff"]);
      ...
      <div className="sticky top-0  z-10">
        ...
        <div className=" flex h-screen justify-between items-center left-20 lg:ml-5 px-10">
          <p className="max-w-[500px] text-neutral-500  text-2xl leading-10">
            ...
            <motion.span style={{ color: col2 }}>tempore</motion.span>, <motion.span style={{ color: col3 }}>fuga</motion.span>,
            nisi <motion.span style={{ color: col }}>maiores</motion.span>{" "}
            aspernatur neque, nostrum eligendi aperiam sequi temporibus dolor
            reiciendis corporis numquam molestias! Assumenda, illum sequi?
            Facilis, atque.
          </p>
        </div>

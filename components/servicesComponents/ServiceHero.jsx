...
//               <motion.div
//                 ref={scope}
//                 className="mt-20 flex flex-col justify-center items-center px-3 "
//               >
//                 <motion.h1 className=" font-semibold text-center text-neutral-100 text-3xl xl:text-4xl 2xl:text-5xl pb-6 leading-tight flex flex-col max-w-4xl z-10">
//                   <motion.span initial={{ opacity: 0, y: 80 }}>
//                     isaidfu isadufn ybguywbd uaywbda ausyduysa uyas dyusa ysasy
//                     usi fu
//                   </motion.span>
//                 </motion.h1>
//                 <p className=" text-center text-neutral-200 text-base md:text-lg flex flex-col z-10 ">
//                   <motion.span initial={{ opacity: 0, y: 80 }} className="z-10">
//                     n aisnfi nsfidu nsidf naisoune iofunsiefnai fneinse
//                     fpiansepfi nsepiunsf fuj asdf fwq iubpiu ompoi pisaeuf
//                     paishefpiusafpi abnse pibsaefi ae iuhs piuas pius fpisefiuh{" "}
